...
%% A. Significant lichen interaction network structure resulting
%%   from tree genotypic variation was observed in the common garden.
%%   The plot shows genotype centroids of NMDS ordinated (R2 = 0.999,
  %% stress = 0.008) lichen networks (1 S.E.). Centroids that are
