...
quantify the genetic component (i.e. heritabible variation) in network
structure.

What are the potential issues/concerns of not considering network
structure?

Namely, we are ignoring how the structure of interactions among
species may influence the impact of selection in real ecosystems. \\

1. Indirect effects and IIGEs \cite{Thompson2014, Whitham2020} \\
2. Structure and function -> evolution/ecology \cite{Watts1999, Novak2006, Bascompte2014} \\
3. Metrics \cite{Lau2017} \\
...
observed on each tree. Based on previous community genetics studies,
particularly the community similarity rule \citep{Bangert2006}, we
hypothesize that trees will vary in some phenotypic traits and those
trees of the same genotype will tend to have similar traits leading to
similarities in lichen network structure.
