...
samples collected in XXXX \textbf{LJL INPUT}. Samples were soaked in
XX ml of XXX water for XX hours and pH was measured using a XX
\textbf{LJL INPUT}.
...
All analyses were conducted using R version 4.0.2 (R Development Core
Team 2020). Code and data for the project are openly available as a
