...
networks, using multiple network metrics. Second, one of the examined
tree traits, bark roughness, was both predicted by tree genotype and
correlated with lichen network similarity, supporting a mechanistic
pathway from a variration in a heritable tree trait and the
genetically based variation in lichen network structure. We conclude
that tree genotype can influence not only the relative abundances of
organisms but also the interaction network structure of associated
organisms. Given that variation in network structure can have
consequences for the dynamics of communities through altering the
stability of the system and modulating or amplifying perturbations,
...
generally do not include a genetic component
\cite{Borrett2014EnaR:Analysis}; and, community genetics studies have
primarily focused on community composition in terms of the abundance
of species \cite{DesRoches2018TheVariation}. Multiple studies from
different plant-associated communities (including \textit{Populus},
\textit{Solidago}, \textit{Oenothera}, \textit{Salix}) have examined
the effect of genetic variation on trohic interactions
\cite{Bailey2005ImportanceInteractions, Johnson2008, Smith2011, Smith2015b,
...
particularly \citep{Bangert2006} which proposed the community
