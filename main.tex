...
Tree-lichen interactions depended on tree genotype. As previously
observed \cite{Lamit2015} percent cover (REML: $R^2$ = 0.17,
\texit{p-value} = 0.039) and community composition (PerMANOVA: ) of varied
significantly among tree genotypes.
