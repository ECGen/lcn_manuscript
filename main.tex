...
to genetic effects. Considering the impact of network structure
(e.g. Nowak 2015) would be a productive path forward for the
theoretical development and application of the IIGE concept. Previous
work has classified several network structures that can impact the
evolutionary dynamics. Although developed at the population scale,
such theory can apply to communities. This theory provides a means to
classify networks into two genreal categories, rooted and cyclic, in
which rooted networks have interactions in which evolutionary effects
...
define it in this context, the previous work \citep{Lau2017},
