...
\item Genotype influenced lichen network structure
  \begin{itemize}
   ...
   \item Supplementary Table. h2-reml
  \end{itemize}
\item Genotype impacts were on positive interactions mainly driven by Ch
  ...
  \item Table 1. REML H2 Centrality (in/out, pos/neg, spp(in/out, pos/neg))
  \end{itemize}
\item Genotype indirectly influenced lichen network centralization via bark roughness
  \begin{itemize}
   ...
   \item Table: Network metric and residual responses LM and REML results
