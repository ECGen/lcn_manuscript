...
\caption{Lichen interaction networks were constructed by conducting
  ...
  due to chance alone, $E[P(S_iS_j)] = P(S_i) P(S_j)$.}
...
\caption{Significant lichen interaction network structure resulting
  ...
  the ordinated networks with tree bark roughness (RB), percent lichen
  cover (PC) and lichen species richness (SR).}
