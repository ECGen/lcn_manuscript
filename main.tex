...
% 1. Lichen network plots
% 2. Lichen network similarity permanova for genotype
% 3. Lichen network NMDS

%% Network centrality was influenced by network structure
% 1. Network centrality by genotype statistics
% 2. Plot of network centrality by genotype
% 3. Other structural statistics (linkages and modularity) 

%% Genetically based tree traits correlated with network structure
% 1. REML tests for traits
% 2. Trait and network PerMANOVA
% 3. Trait and network metric regressions

%% Patterns were similar to wild stands
% 1. Significant correlations of networks and traits
% 2. Ordinations of wild network similarity and traits with network metrics
