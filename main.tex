...
Fundamental to this evolutionary process is the discovery of a genetic
basis to ecological network structure.

Building on previous work demonstrating that tree genotype contributes
to community and interaction network structure, we explored how
genotypic variation contributes to variation in interaction networks
at the scale of individual trees. 


In a long-term experimental common garden of the foundation tree
species \textit{Populus angustifolia} we quantified the interaction
networks of epiphytic lichens on individual trees of known genotype. 

We used this system to test how genetic variation contributes to the
interaction network structure of a model community comprised of
epiphytic lichens. 

We found three main results:  

1) Genotypes tended to support different interaction networks, 

2) 

- How did the structure vary among genotypes?

- What were the potential drivers of interaction network structure?

Interaction network stucture was driven by the dominant lichen species
(Xanthomendoza galericulata) or the formation of textured
(i.e. ``rough'' bark).


         X1       X2     r2 Pr(>r)    
Xg -0.96085  0.27708 0.0496  0.257    
Cs -0.89019 -0.45559 0.1682  0.008 ** 
Ls -0.89704 -0.44196 0.4193  0.001 ***
Ch -0.90593  0.42344 0.2643  0.001 ***
Pm -0.45154 -0.89225 0.0200  0.614    
Pa -0.66179 -0.74969 0.0028  0.924    
Rs -0.97124 -0.23810 0.1166  0.034 *  
R   0.90701  0.42111 0.0623  0.186    
C  -0.96879  0.24790 0.5021  0.001 ***




3) How does this impact stand level lichen netwoks, viewed either as
average unipartite or bipartite networks?



Bipartite network structure based on the average unipartite network
structure of pairwise interactions?

Discussion Points:

- Did not find support for the interacting foundation species
hypothesis, Xgal tracked genotypes and bark roughness but was not
correlated with network similarity even though genotype did determine
network structure.

- The stage of development of interactions, some could be after
sorting and be the evidence of competition already past. We did not
see negative interactions for the most abudnant species, as would be
the case if competition had already played out. 


2) individual tree genotype significantly influenced lichen species
interactions, which was strongly correlated with bark roughness, a
genetically based trait in cottonwoods known to influence epiphytic
lichen, and 
