...
trees. These examples collectively support the possibility that
...
most likely to survive drought and pathogen outbreaks,
...
using \texttt{drake} \citep{drake} archived via Zenodo
