...
different results. It is possible the frequency method over estimating
cover values. Also, like you bring up, just focusing on the north side
and not including the south side would change things since the south
side had far less lichen cover. I think these are both reasons that
your overall \% cover values are much higher than what we got in our
2015 ecology paper. For your data, I calculated the range in the mean
\% total lichen cover among genotypes as ~60-93\% cover, whereas the
range that we report in the 2015 paper is 0.86 – 18.73\%. Again, these
lower values I think are due to some of the sampling differences,
which is totally fine, we should just probably articulate this more
clearly (you have a part in the discussion where I added some thoughts
about this). The other cause of the discrepancy, which I think is much
more important, is the pool of genotypes used. I recall that when we
were getting data for the networks, the main aim was to collect from
genotypes that had a decent amount of lichen cover in order to ensure
you could build networks. Perhaps towards the end you picked up a
couple other genotypes but I think the main set was genotypes with a
fair amount of lichen. In our 2015 paper a main idea and finding was
that genotypes varied in how good they were as substrates for lichen
community formation, with some genotypes having very little cover and
richness while others had much more. This was then related to a shift
in composition that was like the accumulation of species into the
formation of communities as they assemble….basically, some genotypes
allowed for the fast assembly of communities and some did not. The
attached NMDS from our paper shows the basic pattern supporting this
explanation…communities on the left had very little lichen and very
little community overall while those on the far right had much more of
a fully assembled community. What I think is that the pool of
...
covered much greater area on a tree. I don’t think this is a big
issue; since you wanted to characterize communities, it makes sense
that we chose a random pool of genotypes from the upper distribution
of cover and richness so that we could have enough of a community to
build networks. However, it seems that we should make this clear when
describing sampling methods and also help it inform that paragraph in
the discussion when you mention the results from the 2015 paper. Let
me know what you think. I can help with the wording in parts, if you
would like. I am also thinking it would be a useful exercise for me to
select out the composition, richness and \% cover data from the exact
same quadrants as you sampled and do an analysis on them to see if
they also show not difference; this would allow us to know if it is
