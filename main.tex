...
(Table~\ref{tab:h2_table}). Although both showed a response to tree
genotype, bark roughness and condensed tannins were not correlated
(Pearson's $r$ = 0.084, \textit{p-value} = 0.556).
