...
Overall, \% cover values are much higher than observed in a previous
study of bark lichen in the same system \cite{Lamit2015a}. In the
current study mean \% total lichen cover among genotypes ranges from
~60-93\% cover; whereas the range reported in \citep{Lamit2015a} is
0.86-18.73\%. There are several explanations for the observed
differences. 
...
\item The previous study used a visual estimation method, unlike the
  current study, which observed lichen at the scale of 1 cm$^2$ cells,
  which could over-estimate cover depending on the freqeuency at which
  actual thallus size was less than 1 cm$^2$$
...
In part, this is the result of sampling at the quadrat scale. Any
observation of a lichen in this study is given a value of 1 cm$^2$. In
the previous study, percent cover was estimated visually at the scale
of the entire quadrat. Another source of the different in abundance
could result from only using quadrats on the north side. Another
source of difference is the choice of genotypes that were not devoid
of lichen. 

I think there are good legitimate reasons associated with sampling
...
Again, these lower values I think are
