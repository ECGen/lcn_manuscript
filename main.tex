...
\begin{itemize}
\item Revisit the community similarity rule.
\item Add more text here on positive and negative interactions of
  lichen from the literature, lichen could fix nitrogen
\item Elaborate on how many species might be supported by each
...
\item What is the relationship between tree growth, bark roughness
  and disruption of the lichen community? Tree grow and the bark
  expands over time, causing furrows. 
\item Does bark roughness increase habitat and decrease interactions?
\item Differences in network structure could occur without observable
  differences in species richness or community composition
...
\cite{StinchcombeCanHerbivores, Strauss2008EvolutionSizeb}, geographic
