...
Introduce the recent results from DesRoches. 
...
identification of individuals \cite{Lamit2012, Lamit2014, Lamit2015}.
...
optimal performance with count data \citep{Minchen1998}. To quantify
...
\caption{Lichen community composition varied among genotypes. Plot of
  ...
  between bark roughness (BR), percent lichen colonization (PC) and
...
genotype. Percent rough bark varied significantly among genotypes (REML
...
cover (PerMANOVA $R^2$ = 0.236, $F_1$ = 21.2661, p-value = 0.0001) and
lichen species richness (PerMANOVA $R^2$ = 0.054, $F_1$ = 4.9036,
...
predictors. Community similarity was not correlated with network
similarity (Mantel Spearman $\rho$ = 0.092, p-value = 0.09500).
...
correlated with network similarity.  Tree genotype significantly
...
number of links (ANOVA $F_1$ = 6.867, p-value = 0.0114) and centrality
(ANOVA $F_1$ = 8.093, p-value = 0.0063). Lichen species richness was
also correlated with the number of links (ANOVA $F_1$ = 29.436,
p-value = 0.000015) and centrality (ANOVA $F_1$ = 39.488, p-value <
0.000001). Bark roughness, however, did not significantly predict
either the number of links (ANOVA $F_1$ = 2.897, p-value = 0.0946) or
the centrality (ANOVA $F_1$ = 2.591, p-value = 0.1134) of lichen
networks.
...
\begin{itemize}
\item Bark roughness and lichen communities responded to tree
  genotype.
\item Percent rough bark varied significantly among genotypes, as did
  total lichen cover.
\item However, lichen species richness did not show a significant
  response to genotype.
\item Community composition was also affected by tree genotype.
\item In addition, community composition was correlated with bark
  roughness, lichen cover and lichen species richness.
\item However, after controlling for the effect of tree genotype on
  community composition, bark roughness did not significantly predict
  community composition but lichen cover and lichen species richness
  were still significantly correlated with lichen composition.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item We observed significant lichen network structure.
\item This structure varied among genotypes and lichen species varied
  in their importance in the network.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item Lichen networks observed on trees of the same genotype tended to
  be similar in structure.
\item Tree genotype significantly predicted the similarity of lichen
  interaction networks.
\item Bark roughness and lichen species richness were significant
  predictors of lichen network similarity, while total lichen cover
  was a weak, marginally significant predictor.
\item However, after controlling for the effect of tree genotype on
  lichen network similarity, only species richness was a significant
  predictor of lichen network similarity, and neither bark roughness
  nor lichen cover were significant predictors. Community similarity
  was not correlated with network similarity.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item The number of links and network centrality were highly correlated with
network similarity.  
\item Tree genotype significantly predicted network centrality but
marginally predicted the number of links.
\item Total cover was correlated with the number of links and centrality. 
\item Lichen species richness was also correlated with the number of links
and centrality. 
\item Bark roughness, however, did not significantly predict either the
number of links or the centrality of lichen networks.
\end{itemize}

Main discussion points:

\begin{itemize}
\item Re-cap of results and hypotheses
\item Environmental filtering is evidenced by species richness, but
  also possibly species interaction varying based on environment as
  networks varied in terms of sign and magnitude as well
\item The effect of bark roughness on network similarity was primarily
  genetically based, and there are likely other factors at play
\item Implications for other systems
\item Conclusion: Assessing the impact of genetics on ecosystems
\end{itemize}
...
of interacting species. For example, Keith et al. (2017) showed that
the genetics based interactions of aphid resistant and aphid
susceptible trees resulted in different interaction networks of their
associated arthropod communities composed of 139 species. At the scale
of ecosystems, trophic networks or food webs direct and control the
rates of energy and nutrient flux \cite{Borgatti2006}. Furthermore, in
a predator-prey-plant study, Smith \cite{Smith2011}, showed that the
...
discussed to some in previous studies \cite{Bangert2006, Zook2010,
  Zitinska2012}. In the present study, we found that community
...
and time-scales. As heritable variation is the raw material for natural
