...
on individual trees. %% FROM RIKKE's SCRL manuscript
...
species richness and composition were not significanlty responsive to
...
%% of the ``exetended phenotype'' through the self-organization of
