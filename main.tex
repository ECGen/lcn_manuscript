...
Overall, \% cover values are much higher than observed in previous
studies of the genetic basis of bark lichens. 
...
the differences in the findings of both.

\textit{In our 2015 paper a main idea and finding was that genotypes
  varied in how good they were as substrates for lichen community
  formation, with some genotypes having very little cover and richness
  while others had much more. This was then related to a shift in
  composition that was like the accumulation of species into the
  ...
  little community overall while those on the far right had much more
  of a fully assembled community. What I think is that the pool of
  ...
  build networks. However, it seems that we should make this clear
  when describing sampling methods and also help it inform that
  paragraph in the discussion when you mention the results from the
  2015 paper. Let me know what you think. I can help with the wording
  in parts, if you would like. I am also thinking it would be a useful
  exercise for me to select out the composition, richness and \% cover
  data from the exact same quadrants as you sampled and do an analysis
  on them to see if they also show not difference; this would allow us
  to know if it is sampling approach or the total pool of genotypes
  that is driving the differences.}
